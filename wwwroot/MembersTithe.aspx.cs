...
public partial class MembersTithe : System.Web.UI.Page
{
    ...
    void PopulateMembers()
    {
        ...
        if (Session["ShowAll"].ToString() == "Yes")
        {
            Getqry = "SELECT intid, Name + ' ' + Surname,Ward,Ministries,Celno,MemberNo FROM Stats_Form WHERE Tithe = 'Yes'  and ChurchID = '" + Session["ChurchID"].ToString() + "'  and IsActive = '1' and MemberType = 'Member'  ORDER BY  Name + ' ' + Surname ASC";
        }
        else
        {
            Getqry = "SELECT intid, Name + ' ' + Surname,Ward,Ministries,Celno,MemberNo FROM Stats_Form WHERE Tithe = 'Yes'  and ChurchID = '" + Session["ChurchID"].ToString() + "'  and IsActive = '1' and MemberType = 'Member' and campus = '" + Session["Campus"].ToString() + "' ORDER BY  Name + ' ' + Surname ASC";
        }
    ...
    void RunMembers()
    {
        ...
        if (Session["ShowAll"].ToString() == "Yes")
        {
            Getqry = "SELECT intid, Name + ' ' + Surname,gender,Ministries,Celno,MemberNo FROM Stats_Form WHERE Tithe = 'Yes'  and ChurchID = '" + Session["ChurchID"].ToString() + "'  and IsActive = '1' and MemberType = 'Member'  ORDER BY  Name + ' ' + Surname ASC";
        }
        else
        {
            Getqry = "SELECT intid, Name + ' ' + Surname,gender,Ministries,Celno,MemberNo FROM Stats_Form WHERE Tithe = 'Yes'  and ChurchID = '" + Session["ChurchID"].ToString() + "'  and IsActive = '1' and MemberType = 'Member' and campus = '" + Session["Campus"].ToString() + "'  ORDER BY  Name + ' ' + Surname ASC";
        }
