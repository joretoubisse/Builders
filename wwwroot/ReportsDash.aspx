<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportsDash.aspx.cs" Inherits="ReportsDash" %>
											...
											<div class="kt-widget-12__body">
												<div class="kt-widget-12__head">
													<div class="kt-widget-12__date kt-widget-12__date--success">
														<span class="kt-widget-12__day"><label id="DivKids" runat="server"></label></span>
														<span class="kt-widget-12__month"></span>
													</div>
													<div class="kt-widget-12__label">
														<h3 class="kt-widget-12__title">Builders Kidz
										...
										<div class="kt-portlet__foot kt-portlet__foot--md">
											<div class="kt-portlet__foot-wrapper">
												...
												<div class="kt-portlet__foot-toolbar">
													<a href="#" runat="server" id="btnKids" onserverclick="btnKids_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">View Report</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-12">
										<div class="kt-portlet__body">
											<div class="kt-widget-12__body">
												<div class="kt-widget-12__head">
													...
													<div class="kt-widget-12__label">
														<h3 class="kt-widget-12__title">Evangelism Report</h3>
														<span class="kt-widget-12__desc"></span>
													</div>
												</div>
										...
										<div class="kt-portlet__foot kt-portlet__foot--md">
											<div class="kt-portlet__foot-wrapper">
												...
												<div class="kt-portlet__foot-toolbar">
													<a href="#" id="btnViewEvang" runat="server" onserverclick="btnViewEvang_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">View Report</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-12">
										<div class="kt-portlet__body">
											<div class="kt-widget-12__body">
												<div class="kt-widget-12__head">
													...
													<div class="kt-widget-12__label">
														<h3 class="kt-widget-12__title">Discipleship Report</h3>
														<span class="kt-widget-12__desc"></span>
													</div>
												</div>
										...
										<div class="kt-portlet__foot kt-portlet__foot--md">
											<div class="kt-portlet__foot-wrapper">
												...
												<div class="kt-portlet__foot-toolbar">
													<a href="#" id="btnDiscipleship" runat="server" onserverclick="btnDiscipleship_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">View Report</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-12">
										<div class="kt-portlet__body">
											<div class="kt-widget-12__body">
												<div class="kt-widget-12__head">
													...
													<div class="kt-widget-12__label">
														<h3 class="kt-widget-12__title"> Connect Report</h3>
														<span class="kt-widget-12__desc"></span>
													</div>
												</div>
										...
										<div class="kt-portlet__foot kt-portlet__foot--md">
											<div class="kt-portlet__foot-wrapper">
												...
												<div class="kt-portlet__foot-toolbar">
													<a href="#" id="tnConnectPas" runat="server" onserverclick="tnConnectPas_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">View Report</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-12">
										<div class="kt-portlet__body">
											<div class="kt-widget-12__body">
												<div class="kt-widget-12__head">
													...
													<div class="kt-widget-12__label">
														<h3 class="kt-widget-12__title"> Finance Report</h3>
														<span class="kt-widget-12__desc"></span>
													</div>
												</div>
										...
										<div class="kt-portlet__foot kt-portlet__foot--md">
											<div class="kt-portlet__foot-wrapper">
												...
												<div class="kt-portlet__foot-toolbar">
													<a href="#" id="btnWeeklyRep" runat="server" onserverclick="btnWeeklyRep_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">View Report</a>
												</div>
											</div>
										</div>
									</div>
