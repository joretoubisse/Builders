...
public partial class ReportsDash : System.Web.UI.Page
{
    ...
    void RunOnLoad()
    {
        ...
        DivKids.InnerText = connect.SingleRespSQL("SELECT  COUNT(DISTINCT A.intid) FROM Kids A   WHERE A.ChurchID = '" + HttpContext.Current.Session["ChurchID"].ToString() + "' and A.campus = '" + Session["Campus"].ToString() + "' and A.IsActive = '1'");
    ...
    protected void btnKids_ServerClick(object sender, EventArgs e)
    {

        Session["ReportType"] = "Kids";
        Server.Transfer("Reports.aspx");
    }
    protected void btnViewEvang_ServerClick(object sender, EventArgs e)
    {
        Session["ReportType"] = "EvanPastor";
        Server.Transfer("Reports.aspx");
    }
    protected void btnDiscipleship_ServerClick(object sender, EventArgs e)
    {
        Session["ReportType"] = "DesicPastor";
        Server.Transfer("Reports.aspx");
    }
    protected void btnWeeklyRep_ServerClick(object sender, EventArgs e)
    {
        Session["ReportType"] = "WeeklyRep";
        Server.Transfer("RepFinance.aspx");
    }
    protected void tnConnectPas_ServerClick(object sender, EventArgs e)
    {
        Session["ReportType"] = "ConnectPastor";
        Server.Transfer("Reports.aspx");
    }
}