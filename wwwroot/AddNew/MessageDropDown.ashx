...
public class MessageDropDown : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    ...
    public string populateSingle(string prject)
    {
  
        string extraHTML = "";
        #region 
        DataTable det = new DataTable();
       det = connect.DTSQL("SELECT  Idnumber, Name + ' ' + Surname FROM Stats_Form  WHERE ChurchID = '1'");
