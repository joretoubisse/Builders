...
public partial class Reports : System.Web.UI.Page
{
    ...
    void BuildPDFConnectPastor()
    {
        ...
        //  getDate = Convert.ToDateTime("2020-03-26 00:00:00.000").ToString("yyyy-MM-dd");
        string reportName = "Connect_PASTOR" + StartDate + " - " + EndDate;
    ...
    void BuildPDFDiscipleshipPastor()
    {
        ...
        ////if (Session["ShowAll"].ToString() == "Yes")
        ////{
        ////    TeacherTable = connect.DTSQL("SELECT TOP(5) A.Campus,  B.A9 FROM ChurchChecklistholder A INNER JOIN ChurchChecklist B ON A.intid =  B.QuestionID WHERE A.QuestionType = 'Builders Kidz' and A.churchid= '" + Session["ChurchID"].ToString() + "' and convert(varchar, A.UploadDate, 23) between '" + StartDate + "' and '" + EndDate + "'");  //and convert(varchar, B.CapturedDate, 23) between '" + StartDate + "' and '" + EndDate + "'
        ////}
        ////else
        ////{
    ...
    void BuildPDFKids()
    {
        ...
        //  getDate = Convert.ToDateTime("2020-03-26 00:00:00.000").ToString("yyyy-MM-dd");
        string reportName = "Builders Kidz" + StartDate + " - " + EndDate;
