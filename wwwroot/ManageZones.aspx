<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageZones.aspx.cs" Inherits="ManageZones" %>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_subheader" class="kt-subheader kt-grid__item ">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								...
								<a href="ConnectGroups.aspx" id="BackDivs"  runat="server" class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
                                    	<a href="ManageZones.aspx" id="BackDiv" visible="false" runat="server" class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
					...
					<!-- end:: Subheader -->
                   		...
                   		<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="DivUsers" runat="server" visible="false" >
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Users Form</h3>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Add Zones</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<input type="text" class="form-control" runat="server"  id="txtZoneName" aria-describedby="Name" placeholder="Enter Zone">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Zones</h3>
											</div>
										</div>
                    	...
                    	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="EditZoneName" runat="server" visible="false">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Edit Zones</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
 	                                                    ...
 	                                                    <div class="form-group">
													<label>Edit Zone Name</label>
													<input type="text" class="form-control" runat="server"  id="txtEditZone" aria-describedby="Name" placeholder="Enter Zone">

                                                             	
													</div>

                                                           <div class="form-group">
                                                               <button type="reset" runat="server" id="btnUpdateName" onserverclick="btnUpdateName_ServerClick"  visible="true"  class="btn btn-primary">Save</button>
