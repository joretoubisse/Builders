							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Income</h3>
											</div>
										</div>
                                                  ...
                                                  <div class="form-group" runat="server" >
													<label>Type</label>
                                                                              ...
                                                                              <asp:DropDownList runat="server" ID="CmdType" OnSelectedIndexChanged="CmdType_SelectedIndexChanged" AutoPostBack="true"  CssClass="custom-select form-control">
                                                                                  ...
                                                                                  <asp:ListItem Text="Tithe" Value="Tithe" />
                                                                                  <asp:ListItem Text="Offering" Value="Offering" />
													...
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txtIncomeName" aria-describedby="Name" placeholder="Enter Name of income">  	
													</div>
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Income Captured</h3>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Edit Income</h3>
											</div>
										</div>
