<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConnectGroups.aspx.cs" Inherits="ConnectGroups" %>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_subheader" class="kt-subheader kt-grid__item ">
						<div class="kt-container  kt-container--fluid ">
							...
							<a href="ManageZones.aspx" class="btn btn-default btn-sm btn-bold btn-upper">Manage Zone</a>
                                    	<a href="ManageGroup.aspx" class="btn btn-default btn-sm btn-bold btn-upper">Manage Groups</a>
										...
										<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-anim">
											<ul class="kt-nav kt-nav--active-bg" id="m_nav_1" role="tablist">
												...
												<li class="kt-nav__item">
													<a href="AddiConnect.aspx" class="kt-nav__link">
														<i class="kt-nav__link-icon flaticon2-avatar"></i>
														<span class="kt-nav__link-text">Add Connect Groups</span>
													</a>
												</li>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
                                                  ...
                                                  <div class="form-group" runat="server" id="DivZone" >
													<label id="Label1" runat="server">Zone</label> 
                                           ...
                                           <div class="form-group" runat="server" id="Div2" >
                                                    ...
                                                    <button type="reset" runat="server" id="btnSearch" onserverclick="btnSearch_ServerClick" visible="true" class="btn btn-primary pull-right">Search</button>
												<br />	<br />
												</div>

											
                                                  <div class="table-responsive">
                                                     <center> <h3> <label runat="server" id="lblZone"> Zone 1</label></h3></center>
