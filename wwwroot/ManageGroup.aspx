							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Add Groups</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<input type="text" class="form-control" runat="server"  id="txtZoneName" aria-describedby="Name" placeholder="Enter Group Name">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Groups</h3>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Edit Groups</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<input type="text" class="form-control" runat="server"  id="txtEditZone" aria-describedby="Name" placeholder="Enter Groups">
