<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewChecklists.aspx.cs" Inherits="ViewChecklists" %>
	...
	<body runat="server"  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-aside--enabled kt-aside--left kt-aside--fixed kt-aside--offcanvas-default kt-page--loading">
         ...
         <form id="form1" runat="server" class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-aside--enabled kt-aside--left kt-aside--fixed kt-aside--offcanvas-default kt-page--loading">
                <input runat="server" id="IsAdmin" type="hidden" />
                   <input runat="server" id="CheckListID" type="hidden" />
         ...
         <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieRemove" style="display:none;"> Success</button>
          ...
          <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieAccessRight" style="display:none;"> Success</button>
              <button type="button" id="btnViewChecklist" runat="server" onserverclick="btnViewChecklist_ServerClick"  style="display:none;"></button>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
						...
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__toolbar-wrapper">
                                       ...
                                       <button type="reset" runat="server" id="FirstBack"  onserverclick="FirstBack_ServerClick" class="btn btn-default btn-sm btn-bold btn-upper">Back</button>
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content" runat="server" visible="true">   	<!-- Add Work here -->
				...
				<!-- begin:: Content -->
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="DivFullDisplay" runat="server" visible="false">  	<!-- Add Work here -->
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
													<h3 class="kt-portlet__head-title"> <label runat="server" id="lblHeader"></label></h3>
											</div>
										</div>
                                               ...
                                               <div class="form-group" runat="server" id="Div1" >
                                                  ...
                                                  <div class="form-group" runat="server" id="Div3" >
													<label runat="server" id="Label3"> </label>
                                                 	<input type="text" class="form-control" id="Text3" runat="server" readonly>
													</div>


                                                  <div class="form-group" runat="server" id="Div4" >
													<label runat="server" id="Label4"> </label>
                                                 	<input type="text" class="form-control" id="Text4" runat="server" readonly>
													</div>


                                                  <div class="form-group" runat="server" id="Div5" >
													<label runat="server" id="Label5"> </label>
                                                 	<input type="text" class="form-control" id="Text5" runat="server" readonly>
													</div>
                                                  ...
                                                  <div class="form-group" runat="server" id="Div6" >
													<label runat="server" id="Label6"> </label>
                                                 	<input type="text" class="form-control" id="Text6" runat="server" readonly>
													</div>

                                                  <div class="form-group" runat="server" id="Div7" >
													<label runat="server" id="Label7"> </label>
                                                 	<input type="text" class="form-control" id="Text7" runat="server" readonly>
													</div>

                                                  <div class="form-group" runat="server" id="Div8" >
													<label runat="server" id="Label8"> </label>
                                                 	<input type="text" class="form-control" id="Text8" runat="server" readonly>
													</div>
                                                  ...
                                                  <div class="form-group" runat="server" id="Div9" >
													<label runat="server" id="Label9"> </label>
                                                 	<input type="text" class="form-control" id="Text9" runat="server" readonly>
													</div>


                                                  <div class="form-group" runat="server" id="Div10" >
													<label runat="server" id="Label10"> </label>
                                                 	<input type="text" class="form-control" id="Text10" runat="server" readonly>
													</div>
                                                  ...
                                                  <div class="form-group" runat="server" id="Div11" >
													<label runat="server" id="Label11"> </label>
                                                 	<input type="text" class="form-control" id="Text11" runat="server" readonly>
													</div>


                                                  <div class="form-group" runat="server" id="Div12" visible="true" >
													<label runat="server" id="Label12"> </label>
                                                 	<input type="text" class="form-control" id="Text12" runat="server" readonly>
													</div>
		...
		<script>
		    ...
		    function BtnViewMem(id) {
		        document.getElementById('CheckListID').value = id;
		        var clickbutton = document.getElementById('btnViewChecklist');
		        clickbutton.click();
