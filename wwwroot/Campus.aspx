							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Add Campus</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<input type="text" class="form-control" runat="server"  id="txtCampusName" aria-describedby="Name" placeholder="Enter Campus">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Campus</h3>
											</div>
										</div>
