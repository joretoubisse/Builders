					...
					<div id="kt_subheader" class="kt-subheader kt-grid__item ">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								...
								<a href="Admin.aspx" class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
										...
										<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-anim">
											<ul class="kt-nav kt-nav--active-bg" id="m_nav_1" role="tablist">
												...
												<li class="kt-nav__item">
													<a href="" runat="server" id="AddUsers" onserverclick="AddUsers_ServerClick" class="kt-nav__link">
														<i class="kt-nav__link-icon flaticon2-avatar"></i>
														<span class="kt-nav__link-text">Add Users</span>
													</a>
												</li>
											</ul>
										</div>
     			...
     			<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="DivUsers" runat="server" visible="false" >
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
									...
									<select class="form-control kt_selectpicker" data-size="7" data-live-search="true" runat="server" id="PullParents">
												...
												<label>Access Rights * </label>
                                                  ...
                                                  <div class="form-group">
													...
													<input type="password" class="form-control" id="txtPassword" runat="server"  onkeyup="CheckPassword(this.value);"  >
													</div>
                          ...
                          <label id="lblconfirmNewPassMatch" style="margin-left:2%;font-size:large;" class="text-warning"></label>
													...
													<input type="password" class="form-control" id="txtConfirmPassword" runat="server" onkeyup="CheckPasswordNewMatches(this.value);" >
													</div>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="reset" runat="server" id="BtnSave" onserverclick="BtnSave_ServerClick" style="display:none"  class="btn btn-primary">Submit</button>
