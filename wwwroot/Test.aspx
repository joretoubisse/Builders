...
<div id="fb-root"></div>
     ...
     <div id="morrischart" style="height: 250px; width: 250px; float: left">
        ...
        <div id="morrisdetails-item" class="morris-hover morris-default-style" style="position:static;
    float: left;
            ">
                                                        ...
                                                        <div class="row" >
                                                            <div class="col-md-12">                                                               
                                                               <div class="form-group" >
                                                                  <asp:FileUpload ID="BulkLinkFileUpload" runat="server"  CssClass="btn btn-grey btn-block" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <asp:Label ID="UploadStatusLabel" runat="server" CssClass="form-control text-info"></asp:Label>
                                                                </div>
                                                                <div class="form-group" id="formActions" runat="server" visible="false">
                                                                    <asp:TextBox TextMode="MultiLine" ID="txtactionshistory" runat="server" CssClass="form-control"> </asp:TextBox>
                                                                </div>
                                                                <div class="form-actions">
                                                                    <button id="UploadFile_Click" runat="server" class="btn btn-primary" onserverclick="UploadFile_Click_ServerClick">Import</button>
                                                                    <button id="btnImport" runat="server" onserverclick="btnImport_ServerClick" class="btn btn-primary pull-left" style="width:50%;" visible="false">Yes, import</button>
		...
		<script>
		    ...
		    $(document).ready(function () {
		        ...
		        for (i = 0; i < bar.segments.length; i++) {
		            bar.segments[i].handlers['hover'].push(function (i) {
		                $('#morrisdetails-item .morris-hover-row-label').text(donut.data[i].label);
		                $('#morrisdetails-item .morris-hover-point').text(bar.data[i].value);
		            });
		        }
		    });
