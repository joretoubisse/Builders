	...
	<body runat="server"  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-aside--enabled kt-aside--left kt-aside--fixed kt-aside--offcanvas-default kt-page--loading">
         ...
         <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieRemove" style="display:none;"> Success</button>
          ...
          <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieAccessRight" style="display:none;"> Success</button>
                ...
                <button type="button" id="btnViewMessage" runat="server" onserverclick="btnViewMessage_ServerClick"  style="display:none;"></button>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_subheader" class="kt-subheader kt-grid__item ">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								...
								<a href="Notification.aspx"  runat="server"   id="btnDashboard" class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content" runat="server">  	<!-- Add Work here -->
                       ...
                       <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="ShowDetails" runat="server" visible="false">  	<!-- Add Work here -->
							...
							<div class="row">
								<div class="col-md-4">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">All Members who received the message</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
                                                  ...
                                                  <div class="table-responsive">
											       <asp:Literal ID="txtListofMembers" runat="server"></asp:Literal>
													</div>
									...
									<div class="kt-portlet">
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<label>Subject</label>
													<input type="text" class="form-control" id="txtSubject" readonly runat="server" aria-describedby="Subject" placeholder="Enter Subject" autocomplete="off">
 	                                        ...
 	                                        <div class="form-group"  id="DivMessage" runat="server" >
													<label>Message</label>
													<textarea rows="4" cols="50" class="form-control" id="txtMessage" readonly autocomplete="off" runat="server">
		...
		<script>
		    ...
		    function BtnViewMem(id) {
		        ...
		        var clickbutton = document.getElementById('btnViewMessage');
		        clickbutton.click();
