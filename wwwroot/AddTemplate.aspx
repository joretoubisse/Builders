									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Message Template</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
													...
													<input type="text" class="form-control" id="txtMessage" autocomplete="off" runat="server" aria-describedby="txtMessage" placeholder="">
													</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">All Templates</h3>
											</div>
										</div>
