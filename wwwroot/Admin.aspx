						...
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								...
								<a href="Dashboard.aspx" class="btn btn-default btn-sm btn-bold btn-upper">Dashboard</a>
                                    	<a href="Dashboard.aspx"  id="Btn1" onserverclick="Btn1_ServerClick" runat="server" visible="false" class="btn btn btn-primary btn-sm btn-bold btn-upper">Benoni</a>
                                      	<a href="Dashboard.aspx" id="Btn2" onserverclick="Btn2_ServerClick" runat="server" visible="false"  class="btn btn-default btn-sm btn-bold btn-upper">Delmas</a>
                                    	<a href="Dashboard.aspx" id="Btn3" onserverclick="Btn3_ServerClick" runat="server" visible="false"  class="btn btn-default btn-sm btn-bold btn-upper">Eloff</a>
					...
					<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="row">
								<div class="col-md-12">
                                    		...
                                    		<div class="row">
								<div class="col-lg-12" runat="server" id="Main" visible="false">

									<!--begin::Portlet-->
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Admin Console</h3>
											</div>
										</div>
										<div class="kt-portlet__body">
											<ul class="nav nav-pills nav-tabs-btn" role="tablist">
												...
												<li class="nav-item" runat="server" visible="false" id="ShowCampus">
													<a class="nav-link"  href="Campus.aspx" >
														<span class="nav-link-icon"><i class="flaticon2-placeholder"></i></span>
														<span class="nav-link-title">Campus</span>
													</a>
												</li>


                                                	<li class="nav-item" runat="server" visible="false" id="SmsPort">
													<a class="nav-link"  href="SmsPortal.aspx" >
														<span class="nav-link-icon"><i class="fa fa-key"></i></span>
														<span class="nav-link-title">Sms Portal</span>
													</a>
												</li>
											</ul>
	                      ...
	                      <div class="col-lg-12" runat="server" id="DivNotAdmin" visible="true">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<center><h1>Only Admin</h1></center>
