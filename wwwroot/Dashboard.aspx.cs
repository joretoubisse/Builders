...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    {
		//Session["SuperUser"] = txtUsername.Text;
    ...
    void RunDashboard()
    {
		...
		//if (HttpContext.Current.Session["UsersID"].ToString() == "1" || HttpContext.Current.Session["UsersID"].ToString() == "22")
		...
		//Ntable = connect.DTSQL("SELECT  intid,username, name + ' ' +  surname,access,emailAdd,name,Campus,churchid, Pword,AdminRole,MembersRole ,VisitorRole ,SundaySchoolRole ,AttendanceRole ,Communication,Offering,NewMembersAppRole ,ConnectGroupRole,EventsRole ,ResourceRole,MinistryRole,EvangelistRole ,ReportsRole  FROM ChurchUsers  Where Username = '" + acce + "'");
		...
		//{
					...
					//html += NumberOfConnectGrp();
					//txtDash.Text = html;
			//if (Session["FName"].ToString().Equals("Sipho") || Session["FName"].ToString().Equals("Hope"))
			// html += SundaySchool();
