					...
					<div id="kt_subheader" class="kt-subheader kt-grid__item ">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								...
								<a href="Offering.aspx" id="NormalBack" runat="server" class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
							...
							<div class="row">
								<div class="col-md-12">
											...
											<div class="kt-portlet__body">
                                                  ...
                                                  <div class="form-group" runat="server" >
													<label>Type</label>
                                                                              ...
                                                                              <asp:DropDownList runat="server" ID="CmdType" OnSelectedIndexChanged="CmdType_SelectedIndexChanged" AutoPostBack="true"  CssClass="custom-select form-control">
                                                                                <asp:ListItem Text="Please Select" Value="none" />
                                                                                  <asp:ListItem Text="Labor" Value="Labor" />
                                                                                  <asp:ListItem Text="Electricity" Value="Electricity" />
                                                                                  <asp:ListItem Text="Rent or Mortgage" Value="Rent or Mortgage" />
                                                                                     <asp:ListItem Text="Internet" Value="Internet" />
                                                                                        <asp:ListItem Text="Charity" Value="Charity" />
                                                                                       ...
                                                                                       <asp:ListItem Text="Instruments" Value="Instruments" />
                                                                                             <asp:ListItem Text="Office Supplies" Value="Office Supplies" />
                                                              ...
                                                              <div class="form-group" runat="server" id="CmdExp" visible="false">
													<label>Experience</label>
                                                       ...
                                                       <div class="form-group" runat="server" id="OtherText" visible="false">
													<label>Name of expenses</label>
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txtIncomeName" aria-describedby="Name" placeholder="Enter Name of expense">  	
													</div>
													...
													<label>Amount</label>
													<input type="number" class="form-control" runat="server" autocomplete="off"  id="txtAmount" aria-describedby="Name" min="1" max="9999999999999999" placeholder="Enter Amount">  	
													 <span class="form-text text-muted">Please only enter numbers and use a dot instead of a comma e.g 1500 or 1500.50 </span>
                                                         </div>


                                                         <div class="form-group">
													<label>Amount Date</label>
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txtAmountDate" aria-describedby="Name" placeholder="Enter Date">  	
													</div>
                                                           ...
                                                           <div class="form-group">
                                                               <button type="reset" runat="server" id="btnSaveCampus" onserverclick="btnSaveCampus_ServerClick"  visible="true"  class="btn btn-primary">Save</button>
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Expenses Captured</h3>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Edit Expenses</h3>
											</div>
										</div>
											...
											<div class="kt-portlet__body">
                                                  ...
                                                  <div id="Div1" class="form-group" runat="server" >
													<label>Type</label>
                                                                              ...
                                                                              <asp:DropDownList runat="server" ID="EditCmdType" OnSelectedIndexChanged="EditCmdType_SelectedIndexChanged" AutoPostBack="true"  CssClass="custom-select form-control">
                                                                                    <asp:ListItem Text="Please Select" Value="none" />
                                                                                  <asp:ListItem Text="Labor" Value="Labor" />
                                                                                  <asp:ListItem Text="Electricity" Value="Electricity" />
                                                                                  <asp:ListItem Text="Rent or Mortgage" Value="Rent or Mortgage" />
                                                              ...
                                                              <div class="form-group" runat="server" id="EditCmdExp" visible="false">
													<label>Experience</label>

                                                                              <asp:DropDownList runat="server" ID="EditExp"  CssClass="custom-select form-control">
                                                                                    <asp:ListItem Text="Please Select" Value="none" />
                                                                                  <asp:ListItem Text="Glory Experience" Value="Glory Experience" />
                                                                                  <asp:ListItem Text="J316" Value="J316" />
                                                                                  <asp:ListItem Text="Crusades" Value="Crusades" />
                                                       ...
                                                       <div class="form-group" runat="server" id="EditOtherDiv" visible="false">
													<label>Name of expense</label>
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txteditNameIncome" aria-describedby="Name" placeholder="Enter Name of income">  	
													</div>
													...
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txtEditAmount" aria-describedby="Name" placeholder="Enter Amount">  	
                                                        	 <span class="form-text text-muted">Please only enter numbers and use a dot instead of a comma e.g 1500 or 1500.50 </span>
													</div>
                                                         ...
                                                         <div class="form-group">
													<label>Amount Date</label>
													<input type="text" class="form-control" runat="server" autocomplete="off"  id="txtAmountEditDate" aria-describedby="Name" placeholder="Enter Date">  	
													</div>
                                                           ...
                                                           <div class="form-group">
                                                               <button type="reset" runat="server" id="btnSaveEdit" onserverclick="btnSaveEdit_ServerClick"  visible="true"  class="btn btn-primary">Save</button>
													<button type="reset" runat="server" id="btnGoBack" onserverclick="btnGoBack_ServerClick" class="btn btn-secondary">Back</button>
                                                               </div>
    ...
    <script type="text/javascript">
		...
		<script>
          ...
          <script>
              ...
              $('#txtAmountEditDate').datetimepicker({
                  format: "yyyy/mm/dd",
                  todayHighlight: true,
                  autoclose: true,
                  startView: 2,
