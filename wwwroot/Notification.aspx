  ...
  <script>
	...
	<body id="Body1" runat="server"  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-aside--enabled kt-aside--left kt-aside--fixed kt-aside--offcanvas-default kt-page--loading">
         ...
         <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieRemove" style="display:none;"> Success</button>
          ...
          <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="ExistNotie" style="display:none;"> Success</button>
           <button type="button" class="btn btn-success btn-bold btn-font-sm btn-upper" id="NotieInvalidID" style="display:none;"> Success</button>
               <input runat="server" id="GroupID" type="hidden" />
                        <input runat="server" id="MemberID" type="hidden" />
               <button type="button" id="RemoveMemberA" runat="server"  onserverclick="RemoveMemberA_ServerClick"  style="display:none;"></button>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="kt-header kt-grid__item kt-grid kt-grid--ver  kt-header--fixed ">
						...
						<div class="kt-header-menu-wrapper kt-grid__item" id="kt_header_menu_wrapper">
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile " runat="server" visible="false" >
						...
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__toolbar-wrapper">
                                             	<a href="Dashboard.aspx" id="btnBack" onserverclick="btnBack_ServerClick" runat="server" visible="false"  class="btn btn-default btn-sm btn-bold btn-upper">Back</a>
								<a href="Dashboard.aspx" runat="server" id="btnDash" class="btn btn-default btn-sm btn-bold btn-upper">Dashboard</a>
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="MainDiv" runat="server" visible="true">	<!-- Add Work here -->
					...
					<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="row">
								<div class="col-md-12">
                                    		...
                                    		<div class="row">
								<div class="col-lg-12" runat="server" id="Main" visible="true">
									...
									<div class="kt-portlet">
										...
										<div class="kt-portlet__body">
											<ul class="nav nav-pills nav-tabs-btn" role="tablist">
												...
												<li class="nav-item">
													<a class="nav-link"  href="#" runat="server"  id="btnEvan" onserverclick="btnEvan_ServerClick">
														<span class="nav-link-icon"><i class="fa fa-envelope"></i></span>
														<span class="nav-link-title">Send Messages</span>
													</a>
												</li>
												<li class="nav-item" runat="server" visible="true" id="ShowCampus">
													<a class="nav-link"  href="#" runat="server"  id="btnMem" onserverclick="btnMem_ServerClick">
														<span class="nav-link-icon"><i class="fa fa-pen"></i></span>
														<span class="nav-link-title">Manage Message grouping</span>
													</a>
												</li>
                                                	<li class="nav-item">
													<a class="nav-link"  href="#" runat="server"  id="btnViewMsg" onserverclick="btnViewMsg_ServerClick">
														<span class="nav-link-icon"><i class="fa fa-envelope-open"></i></span>
														<span class="nav-link-title">Sent Messages</span>
													</a>
												</li>

                                                	<li class="nav-item" runat="server" visible="true" id="bt">
													<a class="nav-link"  href="#" runat="server"  id="btnAddTemplate" onserverclick="btnAddTemplate_ServerClick">
														<span class="nav-link-icon"><i class="fa flaticon2-folder"></i></span>
														<span class="nav-link-title">Manage Message Template</span>
													</a>
												</li>
            	...
            	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content" runat="server" visible="false">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="row">
								<div class="col-md-3">
									...
									<div class="kt-portlet" runat="server" id="DivCollectOffering" visible="false">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> 	<label runat="server" id="CollectText">Attendance</label></h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="reset" runat="server" id="BtnSave"   class="btn btn-primary">Submit</button>
													<button type="reset" runat="server" id="btnCancel"  class="btn btn-secondary">Cancel</button>
									...
									<div class="kt-portlet" runat="server" id="Div2">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> <label runat="server" id="Heading">Attendance</label></h3>
											</div>
										</div>
                    	...
                    	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="DivHandleGroups" visible="false" runat="server" >
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="row">
								<div class="col-md-6">
									...
									<!--begin::Portlet collect-->
									<div class="kt-portlet" runat="server" id="Div3" >
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> <label runat="server" id="Label1">Notifications</label></h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__body">
                                                 ...
                                                 <div class="form-group">
													...
													<input type="text" class="form-control" id="txtGroupName" autocomplete="off" runat="server" aria-describedby="txtChurchInv" placeholder="">
													</div>

											</div>
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="reset" runat="server" id="btnSaveGroup" onserverclick="btnSaveGroup_ServerClick"   class="btn btn-primary">Submit</button>
													<button type="reset" runat="server" id="btnCan"  onserverclick="btnCan_ServerClick" class="btn btn-secondary">Cancel</button>
									...
									<!--begin::Portlet collect-->
									<div class="kt-portlet" runat="server" id="Div4">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> <label runat="server" id="Label2">All Notification Groups</label></h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__body">
                                                  ...
                                                  <div class="table-responsive">
											       <asp:Literal ID="txtGroups" runat="server"></asp:Literal>
													</div>
                    	...
                    	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="AddMembers" runat="server" visible="false">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="row">
								<div class="col-md-6">
									...
									<!--begin::Portlet collect-->
									<div class="kt-portlet" runat="server" id="Div5" >
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> <label runat="server" id="txtGrpName">Notifications</label></h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="reset" runat="server" id="btnSaveMember" onserverclick="btnSaveMember_ServerClick"   class="btn btn-primary">Add</button>
													<button type="reset" runat="server" id="btnnBack" onserverclick="btnnBack_ServerClick"  class="btn btn-secondary">Cancel</button>
									...
									<!--begin::Portlet collect-->
									<div class="kt-portlet" runat="server" id="Div6">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title"> <label runat="server" id="lblMemberHeader">All members in the group</label></h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__body">
                                                  ...
                                                  <div class="table-responsive">
											       <asp:Literal ID="txtGroupsMem" runat="server"></asp:Literal>
													</div>
   ...
   <script src="assets/plugins/global/plugins.bundle.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
           ...
           function BtnArchMemA(id) {
               var IsAdmin = document.getElementById('IsAdmin').value;

               if (IsAdmin == "1") {
                   document.getElementById('GroupID').value = id;
                   var clickbutton = document.getElementById('RemoveMemberA');
                   clickbutton.click();
               }
               else {
