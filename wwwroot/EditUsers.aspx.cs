...
public partial class EditUsers : System.Web.UI.Page
{
    ...
    protected void BtnSave_ServerClick(object sender, EventArgs e)
    {
        ...
        int complete = connect.SingleIntSQL("UPDATE  ChurchUsers SET surname = '" + txtSurname.Value + "',Name = '" + txtName.Value + "',access = '" + CmdAccess.Value + "',Pword = '" + strEncodedPassword + "',emailadd = '" + txtEmail.Value + "',lastupdateby = '" + Session["FullName"].ToString() + "' ,LastUpdateDate = GETDATE(),UserRoles = '',AdminRole = '" + AdminRoles + "',MembersRole ='" + MembersRole + "' ,VisitorRole = '" + VisitorsRole + "' ,SundaySchoolRole = '" + SundaySchoolRole + "',AttendanceRole = '" + AttendanceRole + "' ,Communication = '" + CommunicationRole + "',Offering = '" + OfferingRole + "',NewMembersAppRole = '" + NewApplicationRole + "' ,ConnectGroupRole = '" + ConnectGrouRole + "',EventsRole = '" + EventsRoles + "' ,ResourceRole = '" + ResourcesRole + "',MinistryRole = '" + MinistryRole + "',EvangelistRole = '" + EvangelistRole + "' ,ReportsRole = '" + ReportsRole + "',DashboardRole = '" + DashRole + "'  WHERE intid = '" + Session["UserID"].ToString() + "'");
