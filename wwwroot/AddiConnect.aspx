<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddiConnect.aspx.cs" Inherits="AddiConnect" %>
											...
											<div class="kt-portlet__body">
                                               ...
                                               <option value="Zone 2">Zone 2</option>
													...
													<label>Group Name * </label>
                                                          ...
                                                          <asp:DropDownList ID="CmdGroup" OnSelectedIndexChanged="CmdGroup_SelectedIndexChanged"  AutoPostBack="true" runat="server" CssClass="custom-select form-control">
                                          ...
                                          <asp:ListItem Value="Group 2">Group 2</asp:ListItem>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
                                                    ...
                                                    <button type="reset" runat="server" id="btnSave" onserverclick="btnSave_ServerClick"   visible="true" class="btn btn-primary">Save</button>
