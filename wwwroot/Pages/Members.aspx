									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
                                            	...
                                            	<div class="kt-portlet__head-label" runat="server" id="Filter" visible="false">
												   <select class="custom-select form-control" runat="server" id="CmdCampus" style="width:100%">
												...
												<option value="Benoni Campus">Benoni Campus</option>
													...
													</select> &nbsp;&nbsp; <button type="reset"  runat="server" id="btnSearchCampus"  onserverclick="btnSearchCampus_ServerClick"  class="btn btn-primary pull-right">Search</button>
											</div>
										</div>
